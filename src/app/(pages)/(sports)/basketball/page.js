...
import { useGetArticlesByCategoryQuery } from "@/store/api/articleApi";
...
const BasketballPage = () => {
  ...
  const { data, isLoading, isFetching, isError } =
    useGetArticlesByCategoryQuery({ category: "Basketball", page });
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2 pl-4">
                  Latest Basketball news, scores, and updates
                </p>
              </div>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {articles.map((news, i) => (
